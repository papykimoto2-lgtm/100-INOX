...
Ce dépôt est déployé pour **100% INOX** : `config.js` pointe vers le projet Supabase « 100% INOX » (`ixeuosnuiewjqoxoqtnj`), déjà installé (base complète + Edge Functions `connexion`, `gestion-utilisateurs`, `fne-proxy`).
